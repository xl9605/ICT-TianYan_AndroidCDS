...
public class MainActivity extends FragmentActivity implements ViewPager.OnPageChangeListener, TabHost.OnTabChangeListener {
    ...
    private Class fragmentArray[] = { WorkListOperationFragment.class, HistoricalWorkListFragment.class ,DeviceManagementFragment.class ,MineFragment.class};
    private int imageViewArray[] = { R.drawable.tab_todayworklist_btn, R.drawable.tab_historicalworklist_btn, R.drawable.tab_operationtutorials_btn, R.drawable.tab_mine_btn };
   private String textViewArray[] = { "今日工单", "历史工单", "设备管理", "我的"};
    ...
    private void initPage() {
        WorkListOperationFragment WorkListOperationFragment = new WorkListOperationFragment();
        //SelectWorkListFragment selectWorkListFragment = new SelectWorkListFragment();
        HistoricalWorkListFragment historicalWorkListFragment = new HistoricalWorkListFragment();
        DeviceManagementFragment deviceManagementFragment = new DeviceManagementFragment();
        MineFragment mineFragment = new MineFragment();

        //list.add(selectWorkListFragment);
        list.add(WorkListOperationFragment);
        list.add(historicalWorkListFragment);
        list.add(deviceManagementFragment);
